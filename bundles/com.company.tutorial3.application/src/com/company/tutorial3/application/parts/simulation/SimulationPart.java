...
import com.amalgamasimulation.platform.animation.swt.SWT2DSimulationViewTiledMapView;
...
public class SimulationPart {
	...
	private void createContent(Composite parent) {
		animationView = new SWT2DSimulationViewTiledMapView(parent, CoordinatesConverter.getMapCoordinatesConverter(), new TileServer("https://a.tile.openstreetmap.org/", 18));
	...
	private ToolBar createToolBar(Composite parent) {
		...
		ToolbarUtils.addCommandItem(toolBar, IconsMapping.CENTERING, "Center", () -> showAllMap());
		return toolBar;
	}
