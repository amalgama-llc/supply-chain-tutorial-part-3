...
public class RequestGenerator {
	...
	public RequestGenerator(Engine engine, Model model, RealDistribution newRequestIntervalDistribution,
	...
	private void createTransportationRequest() {
		...
		TransportationRequest newRequest = new TransportationRequest(getNextRequestId(), sourceAsset, destAsset,
