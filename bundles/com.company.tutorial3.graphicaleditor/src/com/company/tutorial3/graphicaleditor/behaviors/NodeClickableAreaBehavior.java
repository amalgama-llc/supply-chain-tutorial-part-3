...
public class NodeClickableAreaBehavior extends AbstractBehavior{
...
//			System.out.println("scale = " + oldValue + "\t -> \t" + newValue);
		}
	};
		...
		clickableAreaBinding = new DoubleBinding() {
			...
			protected double computeValue() {
				...
				if (viewer != null) {
					...
					if (creationModel != null && creationModel.isContentPartClickRestricted(NodePart.class)) {
						return 0;
					}
				}
	...
	@Override
	public IVisualPart<GeometryNode<Ellipse>> getHost() {
		return (IVisualPart<GeometryNode<Ellipse>>) super.getHost();
	}
}
